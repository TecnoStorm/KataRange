...
echo "<section>".
"<p> nombre: ". $participante->getNombre()." Categoria: ".$participante->getCategoria()." ronda: ".$ronda." pool: ".$pool." kata: ".$kata.".nota:".$nota. "</p>";
echo "<a href='../Juez/opcionesJuez.php'>    <svg xmlns='http://www.w3.org/2000/svg' width='28' height='28' fill='currentColor' class='bi bi-box-arrow-left' viewBox='0 0 16 16'>

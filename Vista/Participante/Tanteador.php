...
echo "<section class='botonVolver'><a href='ElegirParticipante.php' class='Traducir'> <svg xmlns='http://www.w3.org/2000/svg' width='28' height='28' fill='currentColor' class='bi bi-box-arrow-left' viewBox='0 0 16 16'>
